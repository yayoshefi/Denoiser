...
description=' barbara with Mutual info  ';
%% --------------------------- PARAMETERS ------------------------------
...
%     contexttime=toc-cleaningtime-itertime;
    ...
    fprintf(['#Centers    psnr    Context    noise    ',Parameter.Context,'-Lambda  context(m)  K2   NN   CoOc    CC_{Thr}\n',...
        ' %3u       %2.3f   %2.3f     %3u            %3G           %4.3G   %u    %u    %s     %2.1G\n'],...
        round(size(Centers,3)), result,result2, sigma,Parameter.Spatil.lambda,...
        contexttime/60,length (unique(AssignVec2)),NN,Parameter.Spatil.CoOc,Parameter.Spatil.CoOcThr)
